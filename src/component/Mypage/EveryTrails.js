...
export default class EveryTrails extends Component {
  componentDidMount() {
    var container = document.getElementById('cl_everyTrails'); //지도를 담을 영역의 DOM 레퍼런스
    var options = {
      //지도를 생성할 때 필요한 기본 옵션
  ...
  render() {
    return <div className="cl_everyTrails" id="cl_everyTrails"></div>;
  }
}
